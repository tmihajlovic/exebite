...
namespace Exebite.DataAccess.Test
{
    public sealed class LocationRepositoryTest
    {
        ...
        {
            // Arrange
            var sut = LocationDataForTesing(Methods.GetCurrentMethod() + count + id, count);
        ...
        {
            // Arrange
            var sut = LocationDataForTesing(Methods.GetCurrentMethod(), count);
        ...
        {
            // Arrange
            var sut = CreateOnlyLocationRepositoryInstanceNoData(Methods.GetCurrentMethod());
        ...
        {
            // Arrange
            var sut = LocationDataForTesing(Methods.GetCurrentMethod() + count, count);
        ...
        {
            // Arrange
            var sut = LocationDataForTesing(Methods.GetCurrentMethod(), 1);
        ...
        {
            // Arrange
            var sut = LocationDataForTesing(Methods.GetCurrentMethod() + id, 1);
