...
namespace Exebite.DataAccess.Test.Tests
{
    ...
    public class OrderRepositoryTest
    {
        ...
        public void GetOrdersForCustomer()
        {
            ...
            var customer = AutoMapperHelper.Instance.GetMappedValue<Customer>(context.Customers.Find(1));
        ...
        {
            var context = _factory.Create();
            var order = AutoMapperHelper.Instance.GetMappedValue<Order>(context.Orders.Find(1));
            var newFood = AutoMapperHelper.Instance.GetMappedValue<Food>(context.Foods.First());
            order.Note = "New note";
        ...
        public void AddOrder()
        {
            var context = _factory.Create();
            var newFood = AutoMapperHelper.Instance.GetMappedValue<Food>(context.Foods.First());
            var customer = AutoMapperHelper.Instance.GetMappedValue<Customer>(context.Customers.First());
            var order = new Order();
            order.Meal = new Meal();
